...
/**
 * Logs repair order updates to a file whenever a repair order changes state.
 */
public class RepairOrderLogger extends Logger implements RepairOrderObserver {
    ...
    public void repairOrderUpdated(RepairOrderDTO repairOrderDTO) {
        String repairOrder = formatRepairOrder(repairOrderDTO);
        log(repairOrder);
    }
